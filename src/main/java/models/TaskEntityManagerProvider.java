...
public class TaskEntityManagerProvider extends EntityManagerProvider {

	@Inject
	public TaskEntityManagerProvider(MultiDBSources multiDBSources) {
	...
	public String[] getModelPackages() {
		return new String[] { "models.taskdb" };
	}
}
